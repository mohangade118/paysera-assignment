 ...
 */
final class Version20260426042134 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Added table for users, transactions, and debits';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE transactions (id INT AUTO_INCREMENT NOT NULL, amount DOUBLE PRECISION NOT NULL, status TINYTEXT NOT NULL, note LONGTEXT NOT NULL, receipt VARCHAR(255) NOT NULL, from_account_id INT NOT NULL, to_account_id INT NOT NULL, INDEX IDX_EAA81A4CB0CF99BD (from_account_id), INDEX IDX_EAA81A4CBC58BDC7 (to_account_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(25) NOT NULL, last_name VARCHAR(25) NOT NULL, email VARCHAR(25) NOT NULL, password VARCHAR(50) NOT NULL, contact_no VARCHAR(10) NOT NULL, deleted_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), UNIQUE INDEX UNIQ_1483A5E93F326A05 (contact_no), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
